...
public final class AppConstants {
    ...
    public static final String DB_ROW_ID = "rowId";
    public static final int QUIZ_PROBLEMS_COUNT = 200;
    public static final String INSTANT_QUIZ_URL = "http://mistu.org/etutor/api/get5randomquestion.php";
